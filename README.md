...
Bulit a machine learning model using random forest to predict if the S&P 500 will go up or down the next day. You can find details of the project [here](https://github.com/ItZ2LEO/DigitalPortfolio/tree/main/Stock_Market_Predictions).
